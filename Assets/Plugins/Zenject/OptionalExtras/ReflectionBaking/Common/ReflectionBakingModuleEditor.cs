...
namespace Zenject.ReflectionBaking
{
    public class ReflectionBakingModuleEditor
    {
            ...
            Type memberType, Collection<GenericParameter> genericParams)
        {
            ...
            {
                Debug.LogWarning($"!!! memberType:{memberType}, memberType.IsGenericType:{memberType.IsGenericType}, memberType.ContainsGenericParameters:{memberType.ContainsGenericParameters}, memberType.IsGenericParameter:{memberType.IsGenericParameter}");
                throw;
            }
