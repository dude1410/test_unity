...
public class HeadlessEditor : EditorWindow
{
	...
	public void OnEnable ()
	{
		...
		bool found = false;
		string lastProfile = TBR.HeadlessServer.HeadlessEditorPrefs.LastProfile;
...
#pragma warning restore 0168
	...
	public static void SelectProfile (object data)
	{
		...
		headlessSettings = LoadSettings (HeadlessProfiles.currentProfile, false);
		TBR.HeadlessServer.HeadlessEditorPrefs.LastProfile = HeadlessProfiles.currentProfile;
	}
